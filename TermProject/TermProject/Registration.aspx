    ...
    <form id="form1" runat="server">
        <div id="mainRegisterContainer" class="mainRegister">
            ...
            <div class="register1">
                ...
                Email <br /> 
                <asp:TextBox ID="txtEmail" runat="server" Width="50%"></asp:TextBox><br /><br />
                ...
                Zip <br />
                <asp:TextBox ID="txtZip" runat="server" Width="50%"></asp:TextBox><br /><br />
                ...
                Zip <br />
                <asp:TextBox ID="txtBillingZip" runat="server" Width="50%"></asp:TextBox><br /><br />
